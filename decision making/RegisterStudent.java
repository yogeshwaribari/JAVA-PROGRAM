...
who have already enrolled in the course, determine if it will still be possible for all the NN friends to
 do so or not.
Input Format
...
• For each test case, output Yes if it will be possible for all the NN friends to register for the course.
 Otherwise output No.
• You may print each character of Yes and No in uppercase or lowercase (for example, yes, yEs, YES will 
...
class RegisterStudent
{
	public static void main(String x[])
	{
		...
		System.out.println("Enter group of student enroll in a course");
		int NN = xyz.nextInt();
		System.out.println("Enter maximum capacity of Register Student");
		int MM = xyz.nextInt();
		System.out.println("Enter already enrolled in the course");
		int KK = xyz.nextInt();
		int T = NN+KK;
		if(MM>=T)
		{

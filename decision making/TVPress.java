/*
Question 46: Chef is watching TV. The current volume of the TV is XX. Pressing the volume up button of 
the TV remote increases the volume by 11 while pressing the volume down button decreases the volume by 11.
The chef wants to change the volume from XX to YY. Find the minimum number of button presses required to 
do so.
Input Format
...
class TVPress
{
	public static void main(String x[])
	{
		...
		if(v1>v2)
		{
			System.out.println("Press Volume = " + (v1-v2));
		}
		else
		{
			System.out.println("Press Volume = " + (v2-v1));
		}
	}
}
